...
class Game:
    def __init__(self) -> None:
        ...
        self.tank1 = Tank((45, 243), TANK_1_COLOR, pygame.K_LEFT, pygame.K_UP, pygame.K_RIGHT, pygame.K_DOWN,
                          pygame.K_SPACE)
        self.tank2 = Tank((710, 243), TANK_2_COLOR, pygame.K_a, pygame.K_w, pygame.K_d, pygame.K_s, pygame.K_q)
    ...
    def listen_keyboard(self):
        self.tank1.move(self.map, self.tank2.get_rect())
        self.tank2.move(self.map, self.tank1.get_rect())
